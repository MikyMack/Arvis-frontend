!(function (e) {
  ...
  function y() {
    ...
    g[a].then((a) => {
      const s = e(a).clone();
      t.attr("id") && s.attr("id", t.attr("id")),
        t.attr("class") && s.attr("class", t.attr("class")),
        t.attr("style") && s.attr("style", t.attr("style")),
        t.attr("width") &&
          (s.attr("width", t.attr("width")),
          t.attr("height") || s.removeAttr("height")),
        t.attr("height") &&
          (s.attr("height", t.attr("height")),
          t.attr("width") || s.removeAttr("width")),
        s.insertAfter(t),
        t.trigger("svgInlined", s[0]),
        t.remove();
    });
  }
  (e.fn.inlineSvg = function () {
    ...
    e(".accordion-bottom__item").on("click", function () {
      e(".accordion-bottom__item").removeClass("active"),
        e(this).addClass("active");
    }),
    ...
    e("#scroll-about-sec").on("click", function () {
      e("html, body").animate({ scrollTop: e("#about-sec").offset().top }, 800);
    }),
    ...
    e(".single-inventory-item").on("mouseenter", function () {
      e(".single-inventory-item").removeClass("active"),
        e(this).addClass("active");
    }),
    ...
    e(".advance-search-active").click(function (t) {
      ...
      a.hasClass("open")
        ? (a.removeClass("open").hide(),
          s.removeClass("fa-times").addClass("fa-sliders-up"))
        : (a.addClass("open").show(),
          s.removeClass("fa-sliders-up").addClass("fa-times"));
    }),
    e(document).click(function (t) {
      e(t.target).closest(
        ".advance-search-wrapper, .advance-search-active, .select-group-wrapper"
      ).length ||
        (e(".advance-search-wrapper").removeClass("open").hide(),
        e(".advance-search-active").removeClass("active"),
        e(".advance-search-active i")
          .removeClass("fa-times")
          .addClass("fa-sliders-up"));
    }),
    document.addEventListener("DOMContentLoaded", function () {
      ...
      e.forEach((e, s) => {
        e.addEventListener("mouseenter", function () {
          ...
          document
            .querySelector(".map-popular-list" + (s + 1))
            .classList.add("show"),
            (a = s + 1);
        });
      }),
        ...
        document.addEventListener("click", function (e) {
          e.target.closest(".map-icon") ||
            e.target.closest(".map-popular-list") ||
            t.forEach((e) => e.classList.remove("show"));
        });
    }),
    e(document).ready(function () {
      e(".add-explore-city-icon").on("mouseenter", function () {
        ...
        e(".add-explore-city-icon, .explore-card").on(
          "mouseleave",
          function (t) {
            e(t.relatedTarget).closest(".add-explore-city-icon, .explore-card")
              .length || e(".explore-card").removeClass("active");
          }
        );
    }),
